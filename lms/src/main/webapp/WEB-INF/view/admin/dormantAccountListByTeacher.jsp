			...
			$(document).ready(function() {
				$('#approveBtn').click(function() {
					...
					if(accountActivation) {
						...
						location.replace('${pageContext.request.contextPath}/admin/dormantAccountStateActiveTeacher?accountId=' + activeAccountId);
						...
						<c:if test="${lastPage != 0}">
							<c:forEach var="dormantAccountListByTeacher" items="${dormantAccountListByTeacher}">
								<tr>
									...
									<td>
										<button type="button" id="ActiveBtn" class="btn btn-outline-success" value="${dormantAccountListByTeacher.accountId}">
											활성화
										</button>
									</td>
								</tr>
