				...
				<ul class="pagination">
					...
					<c:choose>
						<c:when test="${currentPage > 1}">
							<li class="page-item">
								<a class="page-link"
								href="${pageContext.request.pathInfo}?currentPage=1&studentName=${studentName}">&lt;&lt;</a>
							</li>
							<li class="page-item">
								<a class="page-link"
								href="${pageContext.request.pathInfo}?currentPage=${currentPage-1}&studentName=${studentName}">&lt;</a>
							</li>
						</c:when>
						<c:otherwise>
							<li class="page-item disabled">
					...
					<c:choose>
						<c:when test="${currentPage < lastPage}">
							...
							<li class="page-item">
								<a class="page-link"
								href="${pageContext.request.pathInfo}?currentPage=${lastPage}&studentName=${studentName}">&gt;&gt;</a>
							</li>
						</c:when>
						<c:otherwise>
							<li class="page-item disabled">
