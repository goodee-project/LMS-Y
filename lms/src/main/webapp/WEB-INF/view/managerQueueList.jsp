...
<html>
	<head>
		<meta charset="UTF-8">
		<title>회원가입 승인대기 중인 운영자 리스트</title>
				...
				<table border="1">
					...
					<tbody>
						<c:forEach var="mql" items="${managerQueueList}">
							<tr class="clickable-row" data-href="${pageContext.request.contextPath}/auth/admin/managerQueueDetail?accountId=${mql.accountId}">
								<td>${mql.accountId}</td>
