							...
							<c:forEach var="qcf" items="${questionComment.questionCommentFileList}">
								...
								<c:if test="${qcf.questionCommentFileSize > 0}">
									<div>
										...
										<a class="removeQuestionCommentFile badge badge-pill badge-danger" href="${pageContext.request.contextPath}/teacher/removeQuestionCommentFile?questionCommentFileUUID=${qcf.questionCommentFileUUID}">삭제</a>
									</div>
								</c:if>
							</c:forEach>
